...
<link rel="stylesheet" type="text/css" href="codemirror-jsonlint-addon.css">
<style>
	.CodeMirror {
...
<script src="codemirror-jsonlint-addon.js"></script>

<textarea width="100%" rows="50"></textarea>
...
<script>
	x = CodeMirror.fromTextArea($.one('textarea'), {
		lineNumbers: true,
		mode: "htmlmixed",
		jsonlint: true
	});

	x.notify('Everything is fantastic');
</script>
